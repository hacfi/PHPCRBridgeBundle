...
namespace hacfi\PHPCRBridgeBundle\EventListener;

use Doctrine\Common\EventSubscriber;
use Doctrine\ORM\Event\LifecycleEventArgs;
use Doctrine\Common\Util\ClassUtils;

use hacfi\PHPCRBridgeBundle\Mapping\Driver\AnnotationDriver;
...
class EntityEventSubscriber implements EventSubscriber
{
    ...
    private function transform($entity, $em)
    {
        ...
        foreach ($bridgedProperties as $property => $documentMappingData) {
            if ($documentMappingData['object'] !== 'document') {
                throw new \Exception('A Doctrine ORM Entity can only be bridged to a PHPCR Document.');
            }
